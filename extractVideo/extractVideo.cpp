...
int mainExtractVideo(){
    demuxer_video("/Users/xiaohanchen/Desktop/milan.mp4","/Users/xiaohanchen/Desktop/milan.h264");
    return 0;
}

int demuxer_video(char *src_url, char *dst_url) {
    int ret = 0;
    ...
    // 找到最佳流
    int audio_stream_index = av_find_best_stream(fmt_ctx, AVMEDIA_TYPE_VIDEO, -1, -1, NULL, 0);
